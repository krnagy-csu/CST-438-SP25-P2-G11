...
export default function Tierlist() {
  ...
  const fetchUserTiers = async (id) => {
    ...
    try {
      const tiersResponse = await fetch(`http://localhost:8080/tier/getByUserId/${id}`, {
        headers: {
          "Authorization": `Bearer ${token}`
        }
      });
  ...
  const fetchSubjects = async () => {
    ...
    try {
      const response = await fetch("http://localhost:8080/tier/getSubjects", {
        headers: {
          "Authorization": `Bearer ${token}`
        }
      });
  ...
  const fetchSubjectEntries = async (subjectId) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/tier/${subjectId}/entries`, {
        headers: {
          "Authorization": `Bearer ${token}`
        }
      });
  ...
  const handleCreateTier = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8080/tier/add", {
        method: "POST",
        headers: {
  ...
  const handleDeleteTier = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/tier/delete/${id}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`
        }
  ...
  const handleUpdateTier = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/tier/edit/${id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
