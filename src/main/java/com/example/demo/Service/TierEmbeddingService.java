...
public class TierEmbeddingService {
    ...
    // @PostConstruct
    // public void init() {
    //     Criteria<String, float[]> criteria = Criteria.builder().setTypes(String.class, float[].class).optModelUrls("djl://ai.djl.huggingface.pytorch/sentence-transformers/all-MiniLM-L6-v2").optEngine("TensorFlow").build();
    //     try {
    ...
    //     String tierText = "S: " + tier.getS() + " A: " + tier.getA() + " B: " + tier.getB() + " C: " + tier.getC() + " D: " + tier.getD() + " F: " + tier.getF();
    //     try {
    //         System.out.println(tierText);
    //         this.init();
